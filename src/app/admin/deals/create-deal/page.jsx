...
import { FaCloudUploadAlt, FaTrashAlt, FaPlus, FaCheck, FaEdit, FaInfoCircle, FaFileAlt, FaFileUpload, FaSearch } from "react-icons/fa";
...
const steps = [
  { title: "Basic Details", icon: FaInfoCircle },
  { title: "Deal Details", icon: FaFileAlt },
  { title: "Document Upload", icon: FaFileUpload },
];
          ...
          {steps.map((s, idx) => {
            ...
            return (
              <React.Fragment key={s.title}>
                <div className="flex flex-col items-center flex-1 min-w-0">
                  <div
                    className={`flex items-center justify-center rounded-full transition-all duration-300 shadow-md ${
                      isCompleted
                        ? "bg-primary border-4 border-primary text-white"
                        : isCurrent
                ...
                {idx < steps.length - 1 && (
                  <div className="h-1 w-full max-w-[80px] bg-primary mx-2 md:mx-4 rounded-full"></div>
                )}
              </React.Fragment>
            );
          })}
          ...
          {step === 0 && (
            <div className=" px-6">
              ...
              <div className="grid grid-cols-1 gap-4">
                <div>
                  <label className="block font-medium mb-2 font16 intervar-font poppins-font">
                    Deal Title
                  </label>
                  <input
                    type="text"
